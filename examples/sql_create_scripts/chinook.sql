...
CREATE DATABASE IF NOT EXISTS `chinook` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `chinook`;

-- Dumping structure for table chinook.album
...
-- Dumping data for table chinook.album: ~347 rows (approximately)
...
-- Dumping structure for table chinook.artist
...
-- Dumping data for table chinook.artist: ~275 rows (approximately)
...
-- Dumping structure for table chinook.customer
...
-- Dumping data for table chinook.customer: ~59 rows (approximately)
...
-- Dumping structure for table chinook.employee
...
-- Dumping data for table chinook.employee: ~8 rows (approximately)
...
-- Dumping structure for table chinook.genre
...
-- Dumping data for table chinook.genre: ~25 rows (approximately)
...
-- Dumping structure for table chinook.invoice
...
-- Dumping data for table chinook.invoice: ~412 rows (approximately)
...
-- Dumping structure for table chinook.invoiceline
...
-- Dumping data for table chinook.invoiceline: ~2,240 rows (approximately)
...
-- Dumping structure for table chinook.mediatype
...
-- Dumping data for table chinook.mediatype: ~5 rows (approximately)
...
-- Dumping structure for table chinook.playlist
...
-- Dumping data for table chinook.playlist: ~18 rows (approximately)
...
-- Dumping structure for table chinook.playlisttrack
...
-- Dumping data for table chinook.playlisttrack: ~8,715 rows (approximately)
...
-- Dumping structure for table chinook.track
...
-- Dumping data for table chinook.track: ~3,483 rows (approximately)
