...
-- Dumping database structure for bikestore
CREATE DATABASE IF NOT EXISTS `bikestore` /*!40100 DEFAULT CHARACTER SET latin2 */;
USE `bikestore`;

-- Dumping structure for table bikestore.brands
...
-- Dumping data for table bikestore.brands: ~9 rows (approximately)
...
-- Dumping structure for table bikestore.categories
...
-- Dumping data for table bikestore.categories: ~7 rows (approximately)
...
-- Dumping structure for table bikestore.customers
...
) ENGINE=InnoDB AUTO_INCREMENT=1446 DEFAULT CHARSET=latin2;

-- Dumping data for table bikestore.customers: ~1,445 rows (approximately)
...
-- Dumping structure for table bikestore.orders
...
) ENGINE=InnoDB AUTO_INCREMENT=1616 DEFAULT CHARSET=latin2;

-- Dumping data for table bikestore.orders: ~1,507 rows (approximately)
...
-- Dumping structure for table bikestore.order_items
...
-- Dumping data for table bikestore.order_items: ~4,678 rows (approximately)
...
-- Dumping structure for table bikestore.products
...
) ENGINE=InnoDB AUTO_INCREMENT=322 DEFAULT CHARSET=latin2;

-- Dumping data for table bikestore.products: ~321 rows (approximately)
...
-- Dumping structure for table bikestore.staffs
...
-- Dumping data for table bikestore.staffs: ~10 rows (approximately)
...
-- Dumping structure for table bikestore.stocks
...
-- Dumping data for table bikestore.stocks: ~856 rows (approximately)
...
-- Dumping structure for table bikestore.stores
...
-- Dumping data for table bikestore.stores: ~3 rows (approximately)
